...
public class Car {
  ...
  /*
   * 의존 객체는 작업하는데 사용하라고 생성자를 호출할 때 외부에서 주입하는 객체이기 때문에 셋터나 겟터를 정의할 필요가 없다. public Engine getEngine()
   * { return engine; } public void setEngine(Engine engine) { this.engine = engine; }
   */
