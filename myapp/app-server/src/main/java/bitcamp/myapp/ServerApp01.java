...
import bitcamp.util.DispacherServlet;
...
public class ServerApp01 {
  ...
  DispacherServlet facadeListener;
  ...
  public ServerApp01(int port) throws Exception {
    ...
    facadeListener = new DispacherServlet(iocContainer);
    prepareMenu();
  }
  ...
  private void prepareMenu() {
    ...
    readingMenu.add("/reading/add?category=2", "등록", facadeListener);
    readingMenu.add("/reading/list?category=2", "목록", facadeListener);
    readingMenu.add("/reading/detail?category=2", "조회", facadeListener);
    readingMenu.add("/reading/update?category=2", "변경", facadeListener);
    readingMenu.add("/reading/delete?category=2", "삭제", facadeListener);
