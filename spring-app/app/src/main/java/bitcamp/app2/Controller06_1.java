...
public class Controller06_1 {
  ...
  public void error1() throws Exception {
    throw new Exception("request handler Exception 발생!");
  ...
  public void error() throws Exception {
    throw new IOException("request handler IOException 발생!");
  }
  ...
  public void error3() throws Exception {
    throw new SQLException("request handler SQLException 발생!");
  }

  //  @ExceptionHandler
  public ModelAndView exceptionHandler(Exception ex) {
    System.out.println("Contrller06_1.exceptionHandler() 호출됨");
